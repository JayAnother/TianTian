package jay.love.tiantian.ui.b.adapter.holder;
...
import jay.love.tiantian.widget.BubbleImageView;
import jay.love.tiantian.widget.BubbleLinearLayout;
import jay.love.tiantian.widget.GifTextView;
...
public class ChatAcceptViewHolder extends BaseViewHolder<MessageInfo> {
    ...
    public void setData(MessageInfo data) {
        ...
        if (data.getContent() != null) {
            ...
            Glide.with(getContext()).load(data.getImageUrl()).override(200,200).into(chatItemContentImage);
