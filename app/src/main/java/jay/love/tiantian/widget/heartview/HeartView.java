package jay.love.tiantian.widget.heartview;
...
public class HeartView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private OnDrawHeartListener mListener;
    public void setOnDrawHeartListener(OnDrawHeartListener listener){
        mListener=listener;
    }
